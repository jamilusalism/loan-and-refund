...
public class SignIn extends javax.swing.JFrame {
    ...
    public void connect() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Cannot connect to the database","Status",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(0, 44, 92));
        setMaximumSize(new java.awt.Dimension(800, 500));
        setMinimumSize(new java.awt.Dimension(800, 500));
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(0, 102, 102));
        jPanel1.setForeground(new java.awt.Color(0, 44, 92));
        ...
        jLabel5.setText("Application for Loan and Refund...    |    © 2021, All Right Reserved");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("".equals(errorMsg)){
            try {
                connect();
                String Query = "SELECT *FROM admin where username='" + user.getText()+"' and password='"+pass.getText()+"'";
                connect();
                st.execute(Query);
                ResultSet rs = st.getResultSet();
                if(rs.next()) {
                    JOptionPane.showMessageDialog(this, "Hi " +user.getText()+ "! You have successfully logged in.");
                    this.dispose();
                    Dashboard main = new Dashboard();
                    main.show(true);    this.hide();
                }
                else {
                    JOptionPane.showMessageDialog(this, "Invalid login details! You are not authorized.");
                ...
                JOptionPane.showMessageDialog(null, "Unable to login at the moment! \n Check your database connection and try again.","Status",JOptionPane.ERROR_MESSAGE);
            }
        }
        else {
